...
function DomTreeBody({ tree }: { tree: Block[] }) {
  return (
...
function asideClassName(float: boolean, mode: Mode): string {
  return cn(
...
function dockZoneClassName(lastDock: Mode): string {
  return cn(
...
function positionStyleFor(float: boolean, flt: Float, height: number): React.CSSProperties {
