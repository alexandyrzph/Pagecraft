        ...
        >
          ...
          >
            <div className="flex items-center gap-2.5 border-b border-zinc-200 px-5 py-3.5">
              ...
              <h2 className="flex-1 text-sm font-bold tracking-tight text-zinc-900">
                Version history
              </h2>
              <button
                onClick={snapshot}
            ...
            <div className="min-h-0 flex-1 overflow-y-auto p-3">
              {loading ? (
                ...
                <p className="px-2 py-10 text-center text-sm text-zinc-400">
                  ...
                  <span className="font-medium text-zinc-500">Save version</span> to capture a
                  restore point — one is also saved each time you publish.
                </p>
              ) : (
