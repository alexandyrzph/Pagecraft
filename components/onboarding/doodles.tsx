...
export function DoodleWave({ className, accent = GOLD }: DoodleProps) {
  ...
  return (
    <motion.svg viewBox="0 0 240 240" className={className} {...float}>
      ...
      <path
        d="M150 58 l4 -12 M176 70 l11 -7 M58 96 l-12 -3"
        stroke={GOLD}
        strokeWidth={3.5}
        strokeLinecap="round"
        fill="none"
  ...
  return (
    <motion.svg viewBox="0 0 240 240" className={className} {...float}>
      ...
      >
        ...
        <path
          d="M196 92 l6 -12 l4 13 l13 3 l-12 6 l1 13 l-9 -8 l-12 5 l5 -12 l-9 -8 z"
          fill={GOLD}
          stroke={INK}
          strokeWidth={2.5}
      ...
      {[
        ...
        <motion.path
          key={k}
          d={`M${x} ${y - 9} v18 M${x - 9} ${y} h18`}
          stroke={GOLD}
          strokeWidth={3.5}
          strokeLinecap="round"
          animate={{ opacity: [0.2, 1, 0.2], scale: [0.7, 1.1, 0.7] }}
          transition={{ duration: 1.8, repeat: Infinity, delay: k * 0.4 }}
...
export function DoodlePublish({ className, accent = GOLD }: DoodleProps) {
  ...
  return (
    <motion.svg viewBox="0 0 240 240" className={className} {...float}>
      <Texture id={tx} kind="stripes" />
      <path
        d="M120 40 C150 66 156 112 150 152 L90 152 C84 112 90 66 120 40 Z"
        fill={`url(#${tx})`}
        stroke={INK}
        strokeWidth={4.5}
      />
      ...
      <motion.path
        d="M106 174 q14 30 28 0"
        stroke={GOLD}
        strokeWidth={6}
        strokeLinecap="round"
        fill="none"
        animate={{ scaleY: [0.6, 1.25, 0.6], opacity: [0.6, 1, 0.6] }}
        transition={{ duration: 0.5, repeat: Infinity }}
        style={{ transformOrigin: "120px 174px" }}
      />
      <path
        d="M150 64 l12 -6 M168 92 l13 0"
        stroke={GOLD}
        strokeWidth={3.5}
        strokeLinecap="round"
        fill="none"
    ...
    <motion.svg viewBox="0 0 240 240" className={className} {...float}>
      ...
      {bits.map(([x, y, c], k) => (
        <motion.rect
          ...
          fill={c as string}
          animate={{
            y: [y as number, (y as number) - 14, y as number],
            rotate: [0, 100, 0],
            opacity: [0.5, 1, 0.5],
          }}
          transition={{ duration: 1.6, repeat: Infinity, delay: k * 0.25 }}
          style={{ transformOrigin: `${x}px ${y}px` }}
        />
      ))}
    </motion.svg>
